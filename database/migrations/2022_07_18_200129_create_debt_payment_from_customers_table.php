...
class CreateDebtPaymentFromCustomersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('debt_payment_from_customers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('debt_payment_from_customers');
    }
}
