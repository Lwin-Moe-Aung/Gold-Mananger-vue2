<template>
  <v-navigation-drawer app color="white" right width="290">
      ...
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              <v-list-item-avatar rounded color="grey lighten-4">
                  <v-img src="images/pos/block.jpg"></v-img>
              </v-list-item-avatar>
              <v-list-item-content>
                  <v-list-item-title class="subtitle-2">Gold ring</v-list-item-title>
              ...
              <v-list-item-action class="caption">1,700,000</v-list-item-action>
          </v-list-item>
      </v-list>
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-content>
                  <v-list-item-title class="subtitle-2">Diamond</v-list-item-title>
              ...
              <v-list-item-action class="caption">2,000,000</v-list-item-action>
          </v-list-item>
      </v-list>
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-content>
                  <v-list-item-title class="subtitle-2">Gold Necklace</v-list-item-title>
                  <v-list-item-subtitle>X1
                      <v-btn plain color="#704232" small>Notes
                          <v-icon right>mdi-pencil</v-icon>
                      </v-btn>
      ...
      <v-toolbar color="rgba(0,0,0,0)" flat>
          <strong>Subtotal</strong><v-spacer></v-spacer><strong>3,700,000</strong>
      </v-toolbar>
      <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n6">
          <span>Tax(10%)</span><v-spacer></v-spacer><span>3,700,000</span>
      </v-toolbar>
      <v-divider class="mx-4"></v-divider>
      <v-toolbar color="rgba(0,0,0,0)" flat>
          <strong>Total</strong><v-spacer></v-spacer><strong>3,700,000</strong>
      </v-toolbar>
