    ...
    <div>
        <admin-layout>
            <div class="d-flex justify-content-between p-3">
                ...
                <Link :href="route('admin.purchase_returns.create')">
            ...
            <section class="content" data-app>
                <v-snackbar
                    ...
                    top="top"
                    >
                    Purchase Return Delete Successfully
                                ...
                                <table class="table table-hover">
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            <td><span class="badge badge-pill bg-warning">{{ data.final_total | formatNumber }}</span></td>
                                            ...
                                            <td>
                                                ...
                                                <Link :href="route('admin.purchase_returns.show',data.transaction_id)">
                                                    <button class="btn btn-warrning btn-sm">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteRecord(id) {
                axios
                    .delete(this.route("admin.purchase_returns.deleteRecord",id))
                    .then(response => {
            ...
            getData(page = 1) {
                let getDataUrlWithoutPagination =
                    "/admin/get-purchase-return-data-lists?" +
                    "q=" +
                    this.search +
                    "&sort_direction=" +
                    this.sort_direction +
